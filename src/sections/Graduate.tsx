...
import Shafa from "@/assets/images/safa.jpg"
import Ayik from "@/assets/images/ayik.jpg"
            ...
            <div className='w-[100%] md:h-[120%] flex justify-center md:gap-0 gap-10 items-center mt-10'>
                <Slide>
                    <GraduateCard
                        ...
                        name='Muhammad Shafa'
                        job='Full Stack Engineer di ASABA INNOTECH'
                    ...
                    <GraduateCard
                        ...
                        name='Ayyasy Rosadi'
                        job='Frontend Developer di Diya Project (sedang mengerjakan tugas akhir)'
