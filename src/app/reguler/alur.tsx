      ...
      isi: (
        <div>
          <div className="md:flex hidden">
            ...
            <div className="h-28 w-[1px] mr-5 bg-gray-800"></div>
          ...
          <div className="flex gap-1 mt-3 text-sm">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex gap-1">
                <p>-</p>
                <p>
                  Biaya dapat diangsur sebanyak <b>3 kali</b>, pembayaran
                  pertama periode <b>(April-September)</b> sebesar{" "}
                  <b>Rp. 4.000.000,-</b> , pembayaran kedua periode{" "}
                  <b>(November-Februari)</b> sebesar <b>Rp. 5.000.000,-</b> ,
                  pembayaran ketiga periode <b>(April-Agustus)</b> sebesar{" "}
                  <b>Rp. 3.000.000,-</b> .
                </p>
              </div>
              <div className="flex gap-1">
        ...
        <div>
          <div className="mb-2">
            <ul className="list-decimal mx-5 mb-5">
              ...
              <li>
                Mengisi formulir pendaftaran yang tersedia di web dengan
                lengkap, <b>PERHATIAN! Kuota terbatas hanya untuk 12 orang</b>,
                jika terpenuhi maka pendaftaran ditutup.
              </li>
              <li>
                Melakukan registrasi dengan membayar biaya awal sebesar Rp.
                4.000.000,- ke rekening yang tertera .
              </li>
              <li>Konfirmasi bukti pembayaran ke nomor whatsapp panitia.</li>
              <li>
                Peserta terdaftar dimasukkan ke grup whatsapp dan siap mengikuti
                tes pemetaan kemampuan.
              </li>
              <li>
                Peserta yang tidak mengikuti tes pemetaan akan didiskualifikasi,
                biaya dikembalikan 100%.
              </li>
        ...
        <div className="md:w-[75vw] mx-auto p-8 bg-slate-100 rounded-2xl shadow-2xl">
          ...
          <div className="px-3 mb-1">
            <p className="font-sans">
              ...
              <b>kuota sangat terbatas</b>, biaya murah dan terjangkau.{" "}
            </p>
          </div>
              ...
              >
                ...
                >
                  <div className="flex justify-between mt-3">
                    <h1
                      className={`font-lato text-2xl transition-colors ease-in-out duration-300 ${
