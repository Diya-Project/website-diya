      ...
      isi: (
        <div>
          <h3 className="font-sans">
            Jl. Prof. M Yamin SH, Khusus Kota Selong, Kec. Selong, Kabupaten
    ...
    },
    {
      ...
      isi: (
        <div>
          ...
          <div className="py-2 hidden md:block font-bold">
            <p>Pembelajaran dimulai pada bulan Oktober 2025.</p>
          </div>
            ...
            <div>
              ...
              <div>
                <p className="font-semibold">
                  Tugas Akhir dan Pengabdian Masyarakat
                </p>
        ...
        <div>
          <div className="mb-2">
            <ul className="list-decimal mx-5 mb-5">
              <li>
                Membayar uang pendaftaran sebesar <b>Rp. 75.000,-</b>
              </li>
              <li>
                Mengisi formulir pendaftaran yang tersedia di web dengan lengkap{" "}
                <b>
                  dari tanggal {start ? formatTime(start) : "-"} sampai{" "}
                  {end ? formatTime(end) : "-"}
                </b>
                .
              </li>
              <li>
                Mengisi formulir izin belajar dari orang tua yang tersedia di
                website (download dan ditandatangani oleh orang tua).
              </li>
              <li>
                Peserta yang telah terdaftar akan dimasukkan ke grup whatsapp.
              </li>
              <li>
                Peserta menunggu waktu tes. (informasi waktu tes akan
                disampaikan melalui group whatsapp)
              </li>
              <li>
                Peserta membawa semua berkas syarat pendaftaran ke kantor Diya
                pada saat tes.
              </li>
              <li>Peserta melakukan tes.</li>
              <li>
                Peserta menunggu pengumuman hasil tes. (pengumuman hasil tes
                akan disampaikan melalui whatsapp)
              </li>
    ...
    <div className="overflow-x-hidden">
      <div className="md:mt-[10rem] mt-[4rem] md:mb-0 mb-10">
        <div className="md:w-[75vw] mx-auto p-8 bg-slate-100 shadow-lg rounded-2xl">
          <h1 className="text-3xl font-sans text-gray-700 font-bold mb-1">
            Beasiswa
          </h1>
          <div className="px-3 mb-1">
            <p className="font-sans">
              Mampu menguasai skill fullstack dev yang dibutuhkan industri
              melalui jalur beasiswa (biaya pendidikan gratis), program khusus
              bagi peserta tidak mampu.{" "}
            </p>
          </div>
          ...
          <div className="px-7">
            <ul className="list-decimal font-sans">
              ...
              <li>Belum menikah.</li>
              <li>
                Mendapat izin dari orang tua (dengan menandatangani surat izin
                orang tua).
              </li>
              ...
              <li>
                Siap berkomitmen menyelesaikan pembelajaran sampai tuntas.
              </li>
              <li>
                Tidak mampu secara finansial dibuktikan dengan surat keterangan
                miskin dari desa/kelurahan.
              </li>
              <li>Melampirkan foto KTP dan KK.</li>
              <li>
                Melampirkan foto bersama orang tua/wali di depan rumah
                (sewaktu-waktu pihak management akan meninjau lokasi rumah jika
                dibutuhkan).
              </li>
          ...
          <Fade triggerOnce={true} direction="left" duration={2000}>
            <div className="flex flex-col absolute md:left-0 pt-5 ">
              {timeline.map((d, i) => (
                <div key={i}>
                  <div
                    className={`transition-all ease-in-out duration-300 w-[3px] bg-blueDiya mx-auto my-1 rounded-xl ${d.size}`}
                  ></div>
          ...
          <div className="flex flex-col space-y-3 md:ml-0 ml-10 mb-10">
            {menuTimeline.map((d, i) => (
              ...
              >
                <div
                  onClick={d.func}
                  className=" bg-slate-100 md:w-[70vw] w-[80vw] mt-10 rounded-l-lg rounded-br-lg rounded-tr-3xl pt-3 pb-6 px-8 shadow-xl transition-all ease-in-out duration-300"
                >
                  <div className="flex justify-between mt-3">
                    <h1
                      className={`font-bree    text-2xl transition-colors ease-in-out duration-300 ${
                        d.key ? "text-[#00698f]" : "text-gray-700"
                      }`}
                    >
                      {d.title}
                    </h1>
                    {d.key ? (
                      <HiOutlineChevronUp
                        className={`w-8 h-8 my-auto cursor-pointer mx-3 transition-all ease-in-out duration-300`}
                      />
                    ) : (
                  ...
                  <div
                    className={`pt-4 transition-all ease-in-out duration-300 ${
                      d.key
                        ? "text-gray-800 visible mt-0"
                        : "invisible text-transparent -mt-3"
                    }`}
                  >
                    <div className={`${d.key ? "" : "hidden"}`}>{d.isi}</div>
                  </div>
                </div>
              </Fade>
            ))}
