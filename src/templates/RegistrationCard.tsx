...
export default function CardRegistration({ title, desc, link }: CardRegistrationAttributes) {
  return (
    <div className="md:w-[45%] w-[90%] h-52 p-6 bg-white border border-gray-200 shadow-xl flex flex-col justify-between">
      <div className='h-[40%]'>
      ...
      <div className='flex justify-start items-end h-[20%]'>
        <a href={link} className="inline-flex font-lato h-12 items-center px-3 py-2 text-2xl font-medium text-center text-white bg-[#00274a] hover:ml-1 rounded-lg hover:bg-[#223c53] focus:ring-4 transition-all ease-in-out duration-200 w-[20%]">
          Daftar
