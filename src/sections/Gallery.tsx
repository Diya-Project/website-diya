...
export default function Gallery() {
    return (
        <div id='5' className='mx-3'>
            ...
            <div className='flex flex-wrap justify-center my-5 md:mx-0 gap-5'>
                <iframe loading='lazy' placeholder='blur' className='md:w-[45%] w-[100%]' src="https://www.youtube.com/embed/Z6h-xxoO6JM?si=aU6PKNCc38VuDYY-" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                <Image loading='lazy' placeholder="blur" className='md:w-[33%] bg-blue-400' src={img2} alt='' />
                <div className='md:w-[18%] gap-5 flex flex-col'>
                    <Image loading='lazy' placeholder="blur" className='md:w-[100%]' src={img1} alt='' />
                    <Image loading='lazy' placeholder="blur" className='md:w-[100%]' src={img10} alt='' />
                </div>
                <div className='md:w-[18%] gap-5 flex flex-col'>
                    <Image loading='lazy' placeholder="blur" className='md:w-[100%]' src={img11} alt='' />
                    <Image loading='lazy' placeholder="blur" className='md:w-[100%]' src={img12} alt='' />
                </div>
                <Image loading='lazy' placeholder="blur" className='md:w-[40%]' src={img3} alt='' />
                <Image loading='lazy' placeholder="blur" className='md:w-[38%]' src={img4} alt='' />
            </div>
