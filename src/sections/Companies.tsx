  ...
  return (
    <div className='bg-neutral-100 md:h-[50vh] p-4 flex items-center flex-col gap-5'>
        ...
        <div className='flex flex-wrap gap-4 w-[100%] h-[100%] justify-center'>
            <CompanyCard borderR link='https://sharingvision.com/wp-content/uploads/2023/06/Logo-Sharingvision-Main.png'/>
            <CompanyCard borderR link='https://mdev.co.id/wp-content/uploads/2024/06/logo_mdi_fix.svg'/>
